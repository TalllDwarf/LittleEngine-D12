...
{
	ID3D12DescriptorHeap* pDescriptorHeaps[] = { m_mainDescriptorHeap };
	m_commandList->SetDescriptorHeaps(_countof(pDescriptorHeaps), pDescriptorHeaps);

	m_commandList->SetGraphicsRootDescriptorTable(rootParameterIndex, m_mainDescriptorHeap->GetGPUDescriptorHandleForHeapStart());
}
